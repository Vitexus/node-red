...
RED.sidebar = (function() {
    ...
    function setupSidebarTabs(sidebar) {
        ...
        const toggleIconClass = sidebar.direction === 'right' ? 'fa-chevron-right' : 'fa-chevron-left';
        const toggleSidebarButton = $('<button class="red-ui-sidebar-toggle-button"><i class="fa ' + toggleIconClass + '"></i></button>')
        toggleSidebarButton.on('click', function() {
            RED.menu.toggleSelected(sidebar.menuToggle);
        })
        RED.popover.tooltip(
            toggleSidebarButton,
            sidebar.direction === 'right' ? RED._('keyboard.toggleSidebar') : RED._('keyboard.togglePalette'),
            sidebar.direction === 'right' ? 'core:toggle-sidebar' : 'core:toggle-palette'
        );
        sidebar.tabBars = {
        ...
        sidebar.toggleButton = toggleSidebarButton;
    ...
    function toggleSidebar(sidebar, state) {
        ...
        if (sidebar.toggleButton) {
            ...
            if (!state) {
                icon.addClass(sidebar.direction === 'right' ? 'fa-chevron-left' : 'fa-chevron-right');
            } else {
                icon.addClass(sidebar.direction === 'right' ? 'fa-chevron-right' : 'fa-chevron-left');
            }
        }
    }
