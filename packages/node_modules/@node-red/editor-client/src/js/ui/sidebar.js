...
RED.sidebar = (function() {
    ...
    function setupSidebarTabs(sidebar) {
        ...
        const toggleIconClass = sidebar.direction === 'right' ? 'fa-caret-square-o-right' : 'fa-caret-square-o-left';
        const toggleSidebarButton = $('<button class="red-ui-sidebar-toggle-button selected"><i class="fa ' + toggleIconClass + '"></i></button>')
        ...
        if (sidebar.direction === 'right') {
            ...
            toggleSidebarButton.insertBefore(sidebars.primary.toggleButton);
        }
    ...
    function toggleSidebar(sidebar, state) {
        ...
        if (sidebar.toggleButton) {
            sidebar.toggleButton.toggleClass('selected', !!state);
