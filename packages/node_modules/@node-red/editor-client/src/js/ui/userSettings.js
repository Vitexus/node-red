            ...
            options: [
                {
                    ...
                    onchange: function(val) {
                        if (val) {
                            ...
                            // Deactivate midnight if it was on
                            document.documentElement.classList.remove("nr-theme-midnight");
                            localStorage.setItem("view-dark-midnight-theme", "false");
                            var el = document.getElementById("user-settings-view-dark-midnight-theme");
                ...
                },
                {
                    ...
                    onchange: function(val) {
                        if (val) {
                            ...
                            // Deactivate galaxy if it was on
                            document.documentElement.classList.remove("nr-theme-dark");
                            localStorage.setItem("view-dark-galaxy-theme", "false");
                            var el = document.getElementById("user-settings-view-dark-galaxy-theme");
                            if (el) { el.checked = false; }
                        } else {
                            document.documentElement.classList.remove("nr-theme-midnight");
                        }
